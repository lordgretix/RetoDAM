        ...
        <fieldset>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-2">
                    ...
                    <asp:TextBox ID="tbFirma" runat="server" type="text" class="form-control"></asp:TextBox>
                </div>
                <div class="form-group col-md-4">
                    <label for="inputEmail4">Latitud/Longitud</label>
                    <asp:TextBox ID="tbLatitud" runat="server" type="text" class="form-control"></asp:TextBox>
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <asp:TextBox ID="tb_descripcion" runat="server" CssClass="form-control"  rows="6" TextMode="multiline" Columns="50" ></asp:TextBox>
