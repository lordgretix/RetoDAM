    ...
    Protected Sub Page_Load() Handles Me.Load
        If Not IsPostBack Then
            ...
            If message IsNot Nothing Then
                ...
                SuccessMessageText = If(message = "ChangePwdSuccess", "Se cambió la contraseña.", If(message = "SetPwdSuccess", "Se estableció la contraseña.", If(message = "RemoveLoginSuccess", "La cuenta se quitó.", [String].Empty)))
